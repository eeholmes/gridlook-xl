...
| AOML 2012 &emsp; [dataset info](https://data.source.coop/bkr/aoml/aoml_2012.icechunk) &emsp; [gridlook viewer](https://eeholmes.github.io/gridlook/#icechunk+https://data.source.coop/bkr/aoml/aoml_2012.icechunk)<br>`https://data.source.coop/bkr/aoml/aoml_2012.icechunk` | Icechunk, Zarr v3 | Could not determine grid type, Cannot read properties of undefined (reading 'store') |
